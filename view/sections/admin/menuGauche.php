				...
				<ul class="nav"><li class="nav-header">Navigation</li>
					...
					<li>
						<a href="bootstrap_4.html">
							<div class="icon-img">
								<img src="../public/templates/TemplateAdmin/assets/img/logo/logo-bs4.png" alt="" />
							</div>
					...
					<li class="has-sub">
						...
						<ul class="sub-menu">
							<li><a href="../public/templates/TemplateAdmin/../public/templates/TemplateAdmin/../public/templates/TemplateAdmin/frontend/template/template_one_page_parallax/index.html" target="_blank">One Page Parallax</a></li>
							<li><a href="../public/templates/TemplateAdmin/../public/templates/TemplateAdmin/../public/templates/TemplateAdmin/frontend/template/template_blog/index.html" target="_blank">Blog</a></li>
							<li><a href="../public/templates/TemplateAdmin/../public/templates/TemplateAdmin/../public/templates/TemplateAdmin/frontend/template/template_forum/index.html" target="_blank">Forum</a></li>
							<li><a href="../public/templates/TemplateAdmin/../public/templates/TemplateAdmin/../public/templates/TemplateAdmin/frontend/template/template_e_commerce/index.html" target="_blank">E-Commerce</a></li>
						</ul>
					</li>
					<li class="has-sub">
						<a href="javascript:;">
					...
					<li class="has-sub">
						...
						<ul class="sub-menu">
							<li><a href="../public/templates/TemplateAdmin/template_html/index_v3.html">HTML</a></li>
							<li><a href="../public/templates/TemplateAdmin/template_ajax/">AJAX</a></li>
							<li><a href="../public/templates/TemplateAdmin/template_angularjs/">ANGULAR JS</a></li>
							<li><a href="../public/templates/TemplateAdmin/template_angularjs10/">ANGULAR JS 10</a></li>
							<li><a href="javascript:alert('Laravel Version only available in downloaded version.');">LARAVEL</a></li>
							<li><a href="../public/templates/TemplateAdmin/template_vuejs/">VUE JS</a></li>
							<li><a href="../public/templates/TemplateAdmin/template_reactjs/">REACT JS</a></li>
							...
							<li><a href="../public/templates/TemplateAdmin/template_material/index_v3.html">MATERIAL DESIGN</a></li>
							<li><a href="../public/templates/TemplateAdmin/template_apple/index_v3.html">APPLE DESIGN</a></li>
							<li><a href="../public/templates/TemplateAdmin/template_transparent/index_v3.html">TRANSPARENT DESIGN <i class="fa fa-paper-plane text-theme"></i></a></li>
							<li><a href="../public/templates/TemplateAdmin/template_facebook/index_v3.html">FACEBOOK DESIGN <i class="fa fa-paper-plane text-theme"></i></a></li>
							<li><a href="../public/templates/TemplateAdmin/template_google/index_v3.html">GOOGLE DESIGN <i class="fa fa-paper-plane text-theme"></i></a></li>
						</ul>
					</li>
					<li class="has-sub">
						<a href="javascript:;">
