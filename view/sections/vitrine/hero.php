<section id="hero" class="hero section dark-background">
  ...
  <img src="public/templates/TemplateVitrine/Logis/assets/img/world-dotted-map.png" alt="" class="hero-bg" data-aos="fade-in">
  ...
  <div class="container">
    <div class="row gy-4 d-flex justify-content-between">
      ...
      <div class="col-lg-5 order-1 order-lg-2 hero-img" data-aos="zoom-out">
        <img src="public/templates/TemplateVitrine/Logis/assets/img/hero-img.svg" class="img-fluid mb-3 mb-lg-0" alt="">
      </div>
