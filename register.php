	...
	<body class="pace-top">
			...
			<div class="register register-with-news-feed">
				...
				<div class="right-content">
					...
					<div class="register-content">
						...
						<form id="registerForm" class="margin-bottom-0">
							...
							<div class="row row-space-10">
								<div class="col-md-6 m-b-15">
									<input type="text" id="prenom" name="prenom" class="form-control" placeholder="Prénom(s)" required />
								</div>
								<div class="col-md-6 m-b-15">
						...
						<div class="row m-b-15">
							<div class="col-md-12">
								<input type="tel" id="telephone" name="telephone" class="form-control" placeholder="Téléphone (ex: +221771234567)" required />
							</div>
						</div>						<label class="control-label">Mot de passe <span class="text-danger">*</span></label>
							<div class="row m-b-15">
								<div class="col-md-12">
									<input type="Password" id="motDePasse" name="motDePasse" class="form-control" placeholder="Mot de passe (min 6 caractères)" required />
								</div>
							</div>
		...
		<script>
			document.getElementById('registerForm').addEventListener('submit', function(e) {
				...
				fetch('auth/processusRegister.php', {
					method: 'POST',
					body: formData
				})
